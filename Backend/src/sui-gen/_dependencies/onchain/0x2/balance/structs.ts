...
export class Supply<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::balance::Supply"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: SupplyFields<T0>, ) { this.$fullTypeName = composeSuiType( Supply.$typeName, ...typeArgs ) as `0x2::balance::Supply<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.value = fields.value; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): SupplyReified<ToPhantomTypeArgument<T0>> { return { typeName: Supply.$typeName, fullTypeName: composeSuiType( Supply.$typeName, ...[extractType(T0)] ) as `0x2::balance::Supply<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => Supply.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Supply.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => Supply.fromBcs( T0, data, ), bcs: Supply.bcs, fromJSONField: (field: any) => Supply.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => Supply.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => Supply.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => Supply.fetch( client, T0, id, ), new: ( fields: SupplyFields<ToPhantomTypeArgument<T0>>, ) => { return new Supply( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class Balance<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::balance::Balance"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: BalanceFields<T0>, ) { this.$fullTypeName = composeSuiType( Balance.$typeName, ...typeArgs ) as `0x2::balance::Balance<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.value = fields.value; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): BalanceReified<ToPhantomTypeArgument<T0>> { return { typeName: Balance.$typeName, fullTypeName: composeSuiType( Balance.$typeName, ...[extractType(T0)] ) as `0x2::balance::Balance<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => Balance.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Balance.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => Balance.fromBcs( T0, data, ), bcs: Balance.bcs, fromJSONField: (field: any) => Balance.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => Balance.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => Balance.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => Balance.fetch( client, T0, id, ), new: ( fields: BalanceFields<ToPhantomTypeArgument<T0>>, ) => { return new Balance( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
