...
export class PurchaseCap<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::kiosk::PurchaseCap"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: PurchaseCapFields<T0>, ) { this.$fullTypeName = composeSuiType( PurchaseCap.$typeName, ...typeArgs ) as `0x2::kiosk::PurchaseCap<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.kioskId = fields.kioskId;; this.itemId = fields.itemId;; this.minPrice = fields.minPrice; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): PurchaseCapReified<ToPhantomTypeArgument<T0>> { return { typeName: PurchaseCap.$typeName, fullTypeName: composeSuiType( PurchaseCap.$typeName, ...[extractType(T0)] ) as `0x2::kiosk::PurchaseCap<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => PurchaseCap.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PurchaseCap.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => PurchaseCap.fromBcs( T0, data, ), bcs: PurchaseCap.bcs, fromJSONField: (field: any) => PurchaseCap.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => PurchaseCap.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => PurchaseCap.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => PurchaseCap.fetch( client, T0, id, ), new: ( fields: PurchaseCapFields<ToPhantomTypeArgument<T0>>, ) => { return new PurchaseCap( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class ItemListed<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::kiosk::ItemListed"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ItemListedFields<T0>, ) { this.$fullTypeName = composeSuiType( ItemListed.$typeName, ...typeArgs ) as `0x2::kiosk::ItemListed<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.kiosk = fields.kiosk;; this.id = fields.id;; this.price = fields.price; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): ItemListedReified<ToPhantomTypeArgument<T0>> { return { typeName: ItemListed.$typeName, fullTypeName: composeSuiType( ItemListed.$typeName, ...[extractType(T0)] ) as `0x2::kiosk::ItemListed<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => ItemListed.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ItemListed.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => ItemListed.fromBcs( T0, data, ), bcs: ItemListed.bcs, fromJSONField: (field: any) => ItemListed.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => ItemListed.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => ItemListed.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => ItemListed.fetch( client, T0, id, ), new: ( fields: ItemListedFields<ToPhantomTypeArgument<T0>>, ) => { return new ItemListed( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class ItemPurchased<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::kiosk::ItemPurchased"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ItemPurchasedFields<T0>, ) { this.$fullTypeName = composeSuiType( ItemPurchased.$typeName, ...typeArgs ) as `0x2::kiosk::ItemPurchased<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.kiosk = fields.kiosk;; this.id = fields.id;; this.price = fields.price; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): ItemPurchasedReified<ToPhantomTypeArgument<T0>> { return { typeName: ItemPurchased.$typeName, fullTypeName: composeSuiType( ItemPurchased.$typeName, ...[extractType(T0)] ) as `0x2::kiosk::ItemPurchased<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => ItemPurchased.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ItemPurchased.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => ItemPurchased.fromBcs( T0, data, ), bcs: ItemPurchased.bcs, fromJSONField: (field: any) => ItemPurchased.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => ItemPurchased.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => ItemPurchased.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => ItemPurchased.fetch( client, T0, id, ), new: ( fields: ItemPurchasedFields<ToPhantomTypeArgument<T0>>, ) => { return new ItemPurchased( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class ItemDelisted<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::kiosk::ItemDelisted"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ItemDelistedFields<T0>, ) { this.$fullTypeName = composeSuiType( ItemDelisted.$typeName, ...typeArgs ) as `0x2::kiosk::ItemDelisted<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.kiosk = fields.kiosk;; this.id = fields.id; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): ItemDelistedReified<ToPhantomTypeArgument<T0>> { return { typeName: ItemDelisted.$typeName, fullTypeName: composeSuiType( ItemDelisted.$typeName, ...[extractType(T0)] ) as `0x2::kiosk::ItemDelisted<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => ItemDelisted.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ItemDelisted.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => ItemDelisted.fromBcs( T0, data, ), bcs: ItemDelisted.bcs, fromJSONField: (field: any) => ItemDelisted.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => ItemDelisted.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => ItemDelisted.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => ItemDelisted.fetch( client, T0, id, ), new: ( fields: ItemDelistedFields<ToPhantomTypeArgument<T0>>, ) => { return new ItemDelisted( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
