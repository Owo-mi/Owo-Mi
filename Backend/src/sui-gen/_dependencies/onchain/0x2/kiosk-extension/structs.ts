...
export class ExtensionKey<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::kiosk_extension::ExtensionKey"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: ExtensionKeyFields<T0>, ) { this.$fullTypeName = composeSuiType( ExtensionKey.$typeName, ...typeArgs ) as `0x2::kiosk_extension::ExtensionKey<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): ExtensionKeyReified<ToPhantomTypeArgument<T0>> { return { typeName: ExtensionKey.$typeName, fullTypeName: composeSuiType( ExtensionKey.$typeName, ...[extractType(T0)] ) as `0x2::kiosk_extension::ExtensionKey<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => ExtensionKey.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ExtensionKey.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => ExtensionKey.fromBcs( T0, data, ), bcs: ExtensionKey.bcs, fromJSONField: (field: any) => ExtensionKey.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => ExtensionKey.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => ExtensionKey.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => ExtensionKey.fetch( client, T0, id, ), new: ( fields: ExtensionKeyFields<ToPhantomTypeArgument<T0>>, ) => { return new ExtensionKey( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
