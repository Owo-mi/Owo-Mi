...
export class RuleKey<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::transfer_policy::RuleKey"; static readonly $numTypeParams = 1;
...
export class TransferRequest<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::transfer_policy::TransferRequest"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferRequestFields<T0>, ) { this.$fullTypeName = composeSuiType( TransferRequest.$typeName, ...typeArgs ) as `0x2::transfer_policy::TransferRequest<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.item = fields.item;; this.paid = fields.paid;; this.from = fields.from;; this.receipts = fields.receipts; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): TransferRequestReified<ToPhantomTypeArgument<T0>> { return { typeName: TransferRequest.$typeName, fullTypeName: composeSuiType( TransferRequest.$typeName, ...[extractType(T0)] ) as `0x2::transfer_policy::TransferRequest<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => TransferRequest.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferRequest.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => TransferRequest.fromBcs( T0, data, ), bcs: TransferRequest.bcs, fromJSONField: (field: any) => TransferRequest.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => TransferRequest.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferRequest.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => TransferRequest.fetch( client, T0, id, ), new: ( fields: TransferRequestFields<ToPhantomTypeArgument<T0>>, ) => { return new TransferRequest( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class TransferPolicy<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::transfer_policy::TransferPolicy"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyFields<T0>, ) { this.$fullTypeName = composeSuiType( TransferPolicy.$typeName, ...typeArgs ) as `0x2::transfer_policy::TransferPolicy<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balance = fields.balance;; this.rules = fields.rules; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): TransferPolicyReified<ToPhantomTypeArgument<T0>> { return { typeName: TransferPolicy.$typeName, fullTypeName: composeSuiType( TransferPolicy.$typeName, ...[extractType(T0)] ) as `0x2::transfer_policy::TransferPolicy<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => TransferPolicy.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicy.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => TransferPolicy.fromBcs( T0, data, ), bcs: TransferPolicy.bcs, fromJSONField: (field: any) => TransferPolicy.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => TransferPolicy.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicy.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicy.fetch( client, T0, id, ), new: ( fields: TransferPolicyFields<ToPhantomTypeArgument<T0>>, ) => { return new TransferPolicy( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class TransferPolicyCap<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::transfer_policy::TransferPolicyCap"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyCapFields<T0>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCap.$typeName, ...typeArgs ) as `0x2::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.policyId = fields.policyId; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): TransferPolicyCapReified<ToPhantomTypeArgument<T0>> { return { typeName: TransferPolicyCap.$typeName, fullTypeName: composeSuiType( TransferPolicyCap.$typeName, ...[extractType(T0)] ) as `0x2::transfer_policy::TransferPolicyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => TransferPolicyCap.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCap.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => TransferPolicyCap.fromBcs( T0, data, ), bcs: TransferPolicyCap.bcs, fromJSONField: (field: any) => TransferPolicyCap.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyCap.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCap.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyCap.fetch( client, T0, id, ), new: ( fields: TransferPolicyCapFields<ToPhantomTypeArgument<T0>>, ) => { return new TransferPolicyCap( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class TransferPolicyCreated<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::transfer_policy::TransferPolicyCreated"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyCreatedFields<T0>, ) { this.$fullTypeName = composeSuiType( TransferPolicyCreated.$typeName, ...typeArgs ) as `0x2::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): TransferPolicyCreatedReified<ToPhantomTypeArgument<T0>> { return { typeName: TransferPolicyCreated.$typeName, fullTypeName: composeSuiType( TransferPolicyCreated.$typeName, ...[extractType(T0)] ) as `0x2::transfer_policy::TransferPolicyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => TransferPolicyCreated.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyCreated.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => TransferPolicyCreated.fromBcs( T0, data, ), bcs: TransferPolicyCreated.bcs, fromJSONField: (field: any) => TransferPolicyCreated.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyCreated.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyCreated.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyCreated.fetch( client, T0, id, ), new: ( fields: TransferPolicyCreatedFields<ToPhantomTypeArgument<T0>>, ) => { return new TransferPolicyCreated( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class TransferPolicyDestroyed<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::transfer_policy::TransferPolicyDestroyed"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: TransferPolicyDestroyedFields<T0>, ) { this.$fullTypeName = composeSuiType( TransferPolicyDestroyed.$typeName, ...typeArgs ) as `0x2::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): TransferPolicyDestroyedReified<ToPhantomTypeArgument<T0>> { return { typeName: TransferPolicyDestroyed.$typeName, fullTypeName: composeSuiType( TransferPolicyDestroyed.$typeName, ...[extractType(T0)] ) as `0x2::transfer_policy::TransferPolicyDestroyed<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => TransferPolicyDestroyed.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => TransferPolicyDestroyed.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => TransferPolicyDestroyed.fromBcs( T0, data, ), bcs: TransferPolicyDestroyed.bcs, fromJSONField: (field: any) => TransferPolicyDestroyed.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => TransferPolicyDestroyed.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => TransferPolicyDestroyed.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => TransferPolicyDestroyed.fetch( client, T0, id, ), new: ( fields: TransferPolicyDestroyedFields<ToPhantomTypeArgument<T0>>, ) => { return new TransferPolicyDestroyed( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
