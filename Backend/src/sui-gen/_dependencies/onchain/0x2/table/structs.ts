...
export function isTable(type: string): boolean { type = compressSuiType(type); return type.startsWith("0x2::table::Table<"); }
...
export class Table<T0 extends PhantomTypeArgument, T1 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::table::Table"; static readonly $numTypeParams = 2;
