...
export class Coin<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::coin::Coin"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: CoinFields<T0>, ) { this.$fullTypeName = composeSuiType( Coin.$typeName, ...typeArgs ) as `0x2::coin::Coin<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balance = fields.balance; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): CoinReified<ToPhantomTypeArgument<T0>> { return { typeName: Coin.$typeName, fullTypeName: composeSuiType( Coin.$typeName, ...[extractType(T0)] ) as `0x2::coin::Coin<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => Coin.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Coin.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => Coin.fromBcs( T0, data, ), bcs: Coin.bcs, fromJSONField: (field: any) => Coin.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => Coin.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => Coin.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => Coin.fetch( client, T0, id, ), new: ( fields: CoinFields<ToPhantomTypeArgument<T0>>, ) => { return new Coin( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class CoinMetadata<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::coin::CoinMetadata"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: CoinMetadataFields<T0>, ) { this.$fullTypeName = composeSuiType( CoinMetadata.$typeName, ...typeArgs ) as `0x2::coin::CoinMetadata<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;
 ...
 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): CoinMetadataReified<ToPhantomTypeArgument<T0>> { return { typeName: CoinMetadata.$typeName, fullTypeName: composeSuiType( CoinMetadata.$typeName, ...[extractType(T0)] ) as `0x2::coin::CoinMetadata<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => CoinMetadata.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => CoinMetadata.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => CoinMetadata.fromBcs( T0, data, ), bcs: CoinMetadata.bcs, fromJSONField: (field: any) => CoinMetadata.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => CoinMetadata.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => CoinMetadata.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => CoinMetadata.fetch( client, T0, id, ), new: ( fields: CoinMetadataFields<ToPhantomTypeArgument<T0>>, ) => { return new CoinMetadata( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class RegulatedCoinMetadata<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::coin::RegulatedCoinMetadata"; static readonly $numTypeParams = 1;
...
export class TreasuryCap<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::coin::TreasuryCap"; static readonly $numTypeParams = 1;
...
export class DenyCap<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::coin::DenyCap"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: DenyCapFields<T0>, ) { this.$fullTypeName = composeSuiType( DenyCap.$typeName, ...typeArgs ) as `0x2::coin::DenyCap<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): DenyCapReified<ToPhantomTypeArgument<T0>> { return { typeName: DenyCap.$typeName, fullTypeName: composeSuiType( DenyCap.$typeName, ...[extractType(T0)] ) as `0x2::coin::DenyCap<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => DenyCap.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DenyCap.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => DenyCap.fromBcs( T0, data, ), bcs: DenyCap.bcs, fromJSONField: (field: any) => DenyCap.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => DenyCap.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => DenyCap.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => DenyCap.fetch( client, T0, id, ), new: ( fields: DenyCapFields<ToPhantomTypeArgument<T0>>, ) => { return new DenyCap( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class CurrencyCreated<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::coin::CurrencyCreated"; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: CurrencyCreatedFields<T0>, ) { this.$fullTypeName = composeSuiType( CurrencyCreated.$typeName, ...typeArgs ) as `0x2::coin::CurrencyCreated<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.decimals = fields.decimals; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): CurrencyCreatedReified<ToPhantomTypeArgument<T0>> { return { typeName: CurrencyCreated.$typeName, fullTypeName: composeSuiType( CurrencyCreated.$typeName, ...[extractType(T0)] ) as `0x2::coin::CurrencyCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => CurrencyCreated.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => CurrencyCreated.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => CurrencyCreated.fromBcs( T0, data, ), bcs: CurrencyCreated.bcs, fromJSONField: (field: any) => CurrencyCreated.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => CurrencyCreated.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => CurrencyCreated.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => CurrencyCreated.fetch( client, T0, id, ), new: ( fields: CurrencyCreatedFields<ToPhantomTypeArgument<T0>>, ) => { return new CurrencyCreated( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
