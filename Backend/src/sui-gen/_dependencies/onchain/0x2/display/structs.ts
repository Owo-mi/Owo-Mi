...
export class Display<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::display::Display"; static readonly $numTypeParams = 1;

 readonly $typeName = Display.$typeName;

 readonly $fullTypeName: `0x2::display::Display<${PhantomToTypeStr<T0>}>`;

 readonly $typeArgs: [PhantomToTypeStr<T0>];

 readonly id: ToField<UID>; readonly fields: ToField<VecMap<String, String>>; readonly version: ToField<"u16">

 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: DisplayFields<T0>, ) { this.$fullTypeName = composeSuiType( Display.$typeName, ...typeArgs ) as `0x2::display::Display<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.fields = fields.fields;; this.version = fields.version; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): DisplayReified<ToPhantomTypeArgument<T0>> { return { typeName: Display.$typeName, fullTypeName: composeSuiType( Display.$typeName, ...[extractType(T0)] ) as `0x2::display::Display<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => Display.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Display.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => Display.fromBcs( T0, data, ), bcs: Display.bcs, fromJSONField: (field: any) => Display.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => Display.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => Display.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => Display.fetch( client, T0, id, ), new: ( fields: DisplayFields<ToPhantomTypeArgument<T0>>, ) => { return new Display( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class DisplayCreated<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::display::DisplayCreated"; static readonly $numTypeParams = 1;

 readonly $typeName = DisplayCreated.$typeName;

 readonly $fullTypeName: `0x2::display::DisplayCreated<${PhantomToTypeStr<T0>}>`;

 readonly $typeArgs: [PhantomToTypeStr<T0>];

 readonly id: ToField<ID>

 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: DisplayCreatedFields<T0>, ) { this.$fullTypeName = composeSuiType( DisplayCreated.$typeName, ...typeArgs ) as `0x2::display::DisplayCreated<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): DisplayCreatedReified<ToPhantomTypeArgument<T0>> { return { typeName: DisplayCreated.$typeName, fullTypeName: composeSuiType( DisplayCreated.$typeName, ...[extractType(T0)] ) as `0x2::display::DisplayCreated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => DisplayCreated.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => DisplayCreated.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => DisplayCreated.fromBcs( T0, data, ), bcs: DisplayCreated.bcs, fromJSONField: (field: any) => DisplayCreated.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => DisplayCreated.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => DisplayCreated.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => DisplayCreated.fetch( client, T0, id, ), new: ( fields: DisplayCreatedFields<ToPhantomTypeArgument<T0>>, ) => { return new DisplayCreated( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
...
export class VersionUpdated<T0 extends PhantomTypeArgument> implements StructClass { static readonly $typeName = "0x2::display::VersionUpdated"; static readonly $numTypeParams = 1;

 readonly $typeName = VersionUpdated.$typeName;

 readonly $fullTypeName: `0x2::display::VersionUpdated<${PhantomToTypeStr<T0>}>`;

 readonly $typeArgs: [PhantomToTypeStr<T0>];

 readonly id: ToField<ID>; readonly version: ToField<"u16">; readonly fields: ToField<VecMap<String, String>>

 private constructor(typeArgs: [PhantomToTypeStr<T0>], fields: VersionUpdatedFields<T0>, ) { this.$fullTypeName = composeSuiType( VersionUpdated.$typeName, ...typeArgs ) as `0x2::display::VersionUpdated<${PhantomToTypeStr<T0>}>`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.version = fields.version;; this.fields = fields.fields; }

 static reified<T0 extends PhantomReified<PhantomTypeArgument>>( T0: T0 ): VersionUpdatedReified<ToPhantomTypeArgument<T0>> { return { typeName: VersionUpdated.$typeName, fullTypeName: composeSuiType( VersionUpdated.$typeName, ...[extractType(T0)] ) as `0x2::display::VersionUpdated<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}>`, typeArgs: [ extractType(T0) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T0>>], reifiedTypeArgs: [T0], fromFields: (fields: Record<string, any>) => VersionUpdated.fromFields( T0, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => VersionUpdated.fromFieldsWithTypes( T0, item, ), fromBcs: (data: Uint8Array) => VersionUpdated.fromBcs( T0, data, ), bcs: VersionUpdated.bcs, fromJSONField: (field: any) => VersionUpdated.fromJSONField( T0, field, ), fromJSON: (json: Record<string, any>) => VersionUpdated.fromJSON( T0, json, ), fromSuiParsedData: (content: SuiParsedData) => VersionUpdated.fromSuiParsedData( T0, content, ), fetch: async (client: SuiClient, id: string) => VersionUpdated.fetch( client, T0, id, ), new: ( fields: VersionUpdatedFields<ToPhantomTypeArgument<T0>>, ) => { return new VersionUpdated( [extractType(T0)], fields ) }, kind: "StructClassReified", } }
