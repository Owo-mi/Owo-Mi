...
export function isFund(type: string): boolean { type = compressSuiType(type); return type === "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::Fund"; }
...
export class Fund implements StructClass { static readonly $typeName = "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::Fund"; static readonly $numTypeParams = 0;

 readonly $typeName = Fund.$typeName;

 readonly $fullTypeName: "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::Fund";
 ...
 private constructor(typeArgs: [], fields: FundFields, ) { this.$fullTypeName = composeSuiType( Fund.$typeName, ...typeArgs ) as "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::Fund"; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.balances = fields.balances;; this.owner = fields.owner;; this.authorizedCaps = fields.authorizedCaps; }

 static reified( ): FundReified { return { typeName: Fund.$typeName, fullTypeName: composeSuiType( Fund.$typeName, ...[] ) as "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::Fund", typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Fund.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Fund.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Fund.fromBcs( data, ), bcs: Fund.bcs, fromJSONField: (field: any) => Fund.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Fund.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Fund.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Fund.fetch( client, id, ), new: ( fields: FundFields, ) => { return new Fund( [], fields ) }, kind: "StructClassReified", } }
...
export function isFundCap(type: string): boolean { type = compressSuiType(type); return type === "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::FundCap"; }

export interface FundCapFields { id: ToField<UID>; fund: ToField<ID> }

export type FundCapReified = Reified< FundCap, FundCapFields >;

export class FundCap implements StructClass { static readonly $typeName = "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::FundCap"; static readonly $numTypeParams = 0;

 readonly $typeName = FundCap.$typeName;

 readonly $fullTypeName: "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::FundCap";

 readonly $typeArgs: [];

 readonly id: ToField<UID>; readonly fund: ToField<ID>

 private constructor(typeArgs: [], fields: FundCapFields, ) { this.$fullTypeName = composeSuiType( FundCap.$typeName, ...typeArgs ) as "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::FundCap"; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.fund = fields.fund; }

 static reified( ): FundCapReified { return { typeName: FundCap.$typeName, fullTypeName: composeSuiType( FundCap.$typeName, ...[] ) as "0x711a02c4e2ba28fce3d9c095a259f622b0502bfc1b96e77b6c0dc136199729f::fund::FundCap", typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => FundCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => FundCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => FundCap.fromBcs( data, ), bcs: FundCap.bcs, fromJSONField: (field: any) => FundCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => FundCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => FundCap.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => FundCap.fetch( client, id, ), new: ( fields: FundCapFields, ) => { return new FundCap( [], fields ) }, kind: "StructClassReified", } }
